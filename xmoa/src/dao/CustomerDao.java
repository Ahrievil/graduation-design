...
public class CustomerDao extends BaseDao{
	...
	public int insertOne(OaCustomer customer){
		...
		return jt.update(sql, max+1,customer.getCuname(),customer.getCutell(),customer.getCuadd(),customer.getCudate(),customer.getCubg(),customer.getCuper());
	}
	public int queryMax() {
	...
	public int update(OaCustomer customer){
		...
		return jt.update(sql,customer.getCuname(),customer.getCutell(),customer.getCuadd(),customer.getCudate(),customer.getCubg(),customer.getCuper(), customer.getCuid());
	}
