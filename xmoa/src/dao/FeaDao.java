...
public class FeaDao extends BaseDao{
	...
	public int insert(OaFeature fea){
		...
		return jt.update(sql, fea.getFeName(),fea.getPrname(),fea.getRname(),fea.getMoName(),fea.getFeNum(),fea.getFeLevel(),fea.getFeCreateTime(),fea.getFeother(),fea.getReother());
	}
	...
	public int update(OaFeature fea){
		...
		return jt.update(sql,fea.getFeName(),fea.getRname(),fea.getMoName(),fea.getFeNum(),fea.getFeLevel(),fea.getFeother(),fea.getReother(),fea.getFeid() );
	}
