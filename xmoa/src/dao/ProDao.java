...
public class ProDao extends BaseDao{
	...
	public int insertPro(OaProject pro){
		...
		return jt.update(sql,pro.getPrName(),pro.getPrClient(),pro.getPrMgr(),pro.getPrNum(),pro.getPrMoney(),pro.getPrStatus(),pro.getPrCost(),pro.getPrStartTime(),pro.getPrEndTime(),pro.getPrLevel(),pro.getPrOther(),pro.getPrSetup());
	}
	...
	public int updateProById(OaProject pro){
		...
		return jt.update(sql,pro.getPrName(),pro.getPrClient(),pro.getPrMoney(),pro.getPrNum(),pro.getPrMgr(),pro.getPrStatus(),pro.getPrCost(),pro.getPrStart(),pro.getPrLevel(),pro.getPrOther(),pro.getPrChangTime(),pro.getPrid());
	}
