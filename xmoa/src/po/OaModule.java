...
public class OaModule {
	...
	public String toString() {
		return "OaModule [moid=" + moid + ", moName=" + moName + ", moMark="
				+ moMark + ", prname=" + prname + ", rname=" + rname
				+ ", reLevel=" + reLevel + ", moCreateTime=" + moCreateTime
				+ ", moChangTime=" + moChangTime + ", moOther=" + moOther
				+ ", reOther=" + reOther + "]";
	}
}
