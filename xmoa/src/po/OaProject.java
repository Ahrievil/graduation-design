...
public class OaProject {
	...
	public String toString() {
		return "OaProject [prid=" + prid + ", prName=" + prName + ", prClient="
				+ prClient + ", prMgr=" + prMgr + ", prNum=" + prNum
				+ ", prMoney=" + prMoney + ", prStatus=" + prStatus
				+ ", prCost=" + prCost + ", prStartTime=" + prStartTime
				+ ", prEndTime=" + prEndTime + ", prStart=" + prStart
				+ ", prEnd=" + prEnd + ", prSetup=" + prSetup + ", prLevel="
				+ prLevel + ", prChangTime=" + prChangTime + ", prExceed="
				+ prExceed + ", prExceedTime=" + prExceedTime + ", prOther="
				+ prOther + ", getPrid()=" + getPrid() + ", getPrName()="
				+ getPrName() + ", getPrClient()=" + getPrClient()
				+ ", getPrMgr()=" + getPrMgr() + ", getPrNum()=" + getPrNum()
				+ ", getPrMoney()=" + getPrMoney() + ", getPrStatus()="
				+ getPrStatus() + ", getPrCost()=" + getPrCost()
				+ ", getPrStartTime()=" + getPrStartTime()
				+ ", getPrEndTime()=" + getPrEndTime() + ", getPrStart()="
				+ getPrStart() + ", getPrEnd()=" + getPrEnd()
				+ ", getPrSetup()=" + getPrSetup() + ", getPrLevel()="
				+ getPrLevel() + ", getPrChangTime()=" + getPrChangTime()
				+ ", getPrExceed()=" + getPrExceed() + ", getPrExceedTime()="
				+ getPrExceedTime() + ", getPrOther()=" + getPrOther()
