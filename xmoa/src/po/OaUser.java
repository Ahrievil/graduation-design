...
public class OaUser {
	...
	public String toString() {
		return "OaUser [usid=" + usid + ", uname=" + uname + ", upwd=" + upwd
				+ ", usex=" + usex + ", ubirthdate=" + ubirthdate + ", uidNum="
				+ uidNum + ", uemail=" + uemail + ", utell=" + utell
				+ ", uadd=" + uadd + ", ustatus=" + ustatus + ", urole="
				+ urole + ", ubankName=" + ubankName + ", ubankAcc=" + ubankAcc
				+ ", upay=" + upay + ", ureward=" + ureward + ", upaje="
				+ upaje + ", uhiredate=" + uhiredate + ", upost=" + upost
				+ ", uother=" + uother + ", uage=" + uage + "]";
	}
}
